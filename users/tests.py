...
class SubscriptionAPITests(APITestCase):
    ...
    def test_create_duplicate_subscription_fails(self):
        ...
        Subscription.objects.create(
            user=self.user1, course=self.course1, is_active=True
        )
        ...
        self.assertEqual(
            response.data["detail"], "Подписка на этот курс уже существует"
        )
    ...
    def test_delete_another_users_subscription(self):
        ...
        Subscription.objects.create(
            user=self.user2, course=self.course1, is_active=True
        )
    ...
    def test_delete_already_inactive_subscription(self):
        ...
        Subscription.objects.create(
            user=self.user1, course=self.course1, is_active=False
        )
